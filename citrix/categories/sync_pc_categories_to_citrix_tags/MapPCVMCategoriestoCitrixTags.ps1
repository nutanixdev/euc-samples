...
.PARAMETER LogRollover
    Optional. The number of days before the log file rolls over. Default is 5 days.
.PARAMETER pc_source
    Mandatory. The Prism Central instance hosting the Source VM and associated Protection Policy.
...
.NOTES
.EXAMPLE
    .\MapPCVMCategoriestoCitrixTags.ps1 -Mode "PrismToCitrix" -pc_source "1.1.1.1" -TagPrefix "Nutanix_" -RemoveOrphanedTags -DDC ""2.2.2.2 -Catalog "Catalog" -Whatif
.EXAMPLE
    .\MapPCVMCategoriestoCitrixTags.ps1 -Mode "PrismToCitrix" -pc_source "1.1.1.1" -TagPrefix "Nutanix_" -RemoveOrphanedTags -CitrixDaaS -CustomerID "fake_cust_id" -SecureClientFile "c:\temp\fakesecret.csv" -Region "US" -Catalog "Catalog" -Whatif
.EXAMPLE
    .\MapPCVMCategoriestoCitrixTags.ps1 -Mode "CitrixToPrism" -pc_source "1.1.1.1" -TagPrefix "Nutanix_" -DDC "2.2.2.2" -Catalog "Catalog" -Whatif
#>
#region Params
# ============================================================================
# Parameters
